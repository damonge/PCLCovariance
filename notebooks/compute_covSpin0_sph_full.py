...
output_dir_NKA = os.path.join('./simulations_outputs/', prefix, 'full_covariance')
output_dir = os.path.join('./simulations_outputs/', prefix, 'full_covariance_spin0')

if not os.path.isdir(output_dir):
    os.makedirs(output_dir)
out_run_path_NKA = os.path.join(output_dir_NKA, prefix)
...
for indices in cov_indices:
    ...
    mask3 = masks[k]
    mask4 = masks[l]
    fname = os.path.join(out_run_path_NKA + '_cw{}{}{}{}.dat'.format(mask1, mask2, mask3, mask4))
