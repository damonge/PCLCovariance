...
\begin{document}
  ...
  \section{Results}\label{sec:results}
    ...
    \subsection{Simulations}\label{ssec:results.sims}
      ...
      \end{equation}
      where $n_\Omega$ is the mean number density of galaxies in units of sterad$^{-2}$ (see below), and $\sigma_\gamma=0.28$ is the intrinsic shape scatter per ellipticity component \todo{cite}.
