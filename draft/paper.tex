...
\begin{document}
  ...
  \section{Analytical Gaussian covariances}\label{sec:theory}
    ...
    \subsection{The pseudo-$C_\ell$ method}\label{ssec:theory.pcl}
      This section provides a very brief introduction to the pseudo-$C_\ell$ power spectrum estimator. Further details can be found in \todo{cite}. 
  ...
  \section{Results}\label{sec:results}
    ...
    \subsection{Quantitative comparison}\label{ssec:results.quant}
      ...
      \begin{figure}
        ...
        \caption{Plot $\chi^2$ TT-TT, TE-TE, EE-EE. \red{Remove ticks and labels in y axis, and just leave $p(\chi^2)$.}} \label{fig:chi2_1bin}
      \end{figure}
      \begin{figure}
        \centering
