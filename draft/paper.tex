...
\section{Analytical Gaussian covariances}
  ...
  \subsection{Preliminaries}\label{ssec:theory.prelim}
    ...
    \begin{equation}\label{eq:iso}
      \langle {\bf a}_{\bf k}{\bf b}^\dag_{\bf l}\rangle\equiv {\sf C}^{ab}_\ell\,F\,\Delta^x({\bf k},{\bf l}),
    \end{equation}
    where $F$ is a volume factor (see below) and ${\sf C}^{ab}_k$ is the power spectrum. Defined this way, the power spectrum is a matrix, with elements
    \begin{equation}
      \left\langle a^\alpha_{\bf k}\left(b^\beta_{\bf l}\right)^*\right\rangle\equiv \left({\sf C}^{ab}_\ell\right)_{\alpha\beta}\,F\,\Delta^x({\bf k},{\bf l}),
    \end{equation}
  ...
  \subsection{The pseudo-$C_\ell$ method}
    ...
    \begin{equation}
      \tilde{\bf a}({\bf x})\equiv w^a({\bf x}){\bf a}({\bf x}),
    \end{equation}
    where $w^a$ is commonly called the ``mask''. Due to the convolution theorem, the generalized Fourier coefficients of the masked field will be a convolution of the mask and true field coefficients:
    \begin{align}\nonumber
    ...
    \begin{align}\nonumber
      \left\langle\tilde{\bf a}_{\bf l}\tilde{\bf b}^\dag_{\bf l}\right\rangle=&\summ{k}\summ{q}\,^a{\sf M}_{{\bf l}{\bf k}}\left\langle{\bf a}_{\bf k}{\bf b}^\dag_{\bf q}\right\rangle\,^b{\sf M}^\dag_{{\bf l}{\bf q}}\\
                                                                              =&F\,\summ{k}\,^a{\sf M}_{{\bf l}{\bf k}}{\sf C}^{ab}_k\,^b{\sf M}^\dag_{{\bf l}{\bf k}}
    \end{align}
    ...
    \begin{enumerate}
      ...
      \end{equation}
      where the bandpower weights are normalized such that $\sum_{{\bf l}\in q}B_q^{\bf l}=(F\Delta^x({\bf l},{\bf l}))^{-1}$.
  ...
  \subsection{Covariance matrices}
    ...
    Let $A$ and $C$ be the vector indices corresponding to the pairs of field indices $(\alpha,\beta)$ and $(\gamma,\delta)$ respectively, and let us start by considering the covariance
    \begin{equation}
      \Sigma^{AC}_{{\bf l}{\bf l}'}\equiv\left\langle\tilde{a}^\alpha_{\bf l}\tilde{b}^{\beta *}_{\bf l}\tilde{c}^\gamma_{{\bf l}'}\tilde{d}^{\delta *}_{{\bf l}'}\right\rangle-\left\langle\tilde{a}^\alpha_{\bf l}\tilde{b}^{\beta *}_{\bf l}\right\rangle\left\langle\tilde{c}^\gamma_{{\bf l}'}\tilde{d}^{\delta *}_{{\bf l}'}\right\rangle
    \end{equation}
    The covariance of the binned bandpowers $\tilde{\sf C}$ can then be computed as
    \begin{equation}\nonumber
      {\rm Cov}\left({\rm vec}\left(\tilde{\sf C}^{ab}_q\right)_A,{\rm vec}\left(\tilde{\sf C}^{cd}_{q'}\right)_C\right)=\sum_{{\bf l}\in q} B^{\bf l}_q\sum_{{\bf l}'\in q'} B^{{\bf l}'}_{q'}\,\Sigma^{AC}_{{\bf l}{\bf l}'}.
    \end{equation}
    ...
    We now make use of Wick's theorem, which states that, for Gaussian fields $\langle a\,b\,c\,d\rangle=\langle a\,b\rangle\langle c\,d\rangle+\langle a\,c\rangle\langle b\,d\rangle+\langle a\,d\rangle\langle b\,c\rangle$. In this case, the expression for $\Sigma^{AC}_{{\bf l}{\bf l'}}$ reads:
    \begin{align}\nonumber
      \Sigma^{AC}_{{\bf l}{\bf l}'}=&\left[F\summ{k}\,^aM^{\alpha\alpha'}_{{\bf l}{\bf k}}\,^dM^{\delta\delta'*}_{{\bf l}'{\bf k}}C^{ad,(\alpha'\delta')}_k\right]\left[\summ{q}\,^bM^{\beta\beta'*}_{{\bf l}{\bf q}}\,^cM^{\gamma\gamma'}_{{\bf l}'{\bf q}}C^{bc,(\beta'\gamma')}_q\right]^*\\
      &+\left((d,\delta)\leftrightarrow(c,\gamma)\right),
    \end{align}
    where we implicitly sum over repeated indices (e.g. $\alpha'$), and the second term is equivalent to the first one after swapping the roles of fields ${\bf c}$ and ${\bf d}$. Without any further approximations, for each pair $({\bf l},{\bf l}')$, we would need to perform two 2-dimensional integrals, and therefore the calculation would scale like $\ell_{\rm max}^6$, quickly becoming unfeasible.
    ...
    \begin{equation}\nonumber
     C^{ad,(\alpha'\delta')}_kC^{bc,(\beta',\gamma')}_q\simeq C^{ad,(\alpha'\delta')}_{(\ell}C^{bc,(\beta',\gamma')}_{\ell')}\equiv\frac{1}{2}\left(C^{ad,(\alpha'\delta')}_\ell C^{bc,(\beta',\gamma')}_{\ell'}+C^{ad,(\alpha'\delta')}_{\ell'} C^{bc,(\beta',\gamma')}_\ell\right).
    \end{equation}
    In this case, the expression for $\Sigma^{AC}_{{\bf l}{\bf l}'}$ reads
    \begin{align}
      \Sigma^{AC}_{{\bf l}{\bf l}'}=C^{ad,(\alpha'\delta')}_{(\ell}C^{bc,(\beta',\gamma')}_{\ell')}\,^{ad}W^{\alpha\delta,\alpha'\delta'}_{{\bf l}{\bf l}'}\,^{bc}\left(\,^{bc}W^{\beta\gamma,\beta'\gamma'}_{{\bf l}{\bf l}'}\right)^*+\left((d,\delta)\leftrightarrow(c,\gamma)\right),
    \end{align}
    where we have defined the covariance coupling coefficients
    \begin{equation}
      \,^{ad}W^{\alpha\delta,\alpha'\delta'}_{{\bf l}{\bf l}'}=\summ{k}\,^aM^{\alpha\alpha'}_{{\bf l}{\bf k}}\left(\,^bM^{\delta\delta'}_{{\bf l}'{\bf k}}\right)^*.
    \end{equation}



    To simplify the calculation we now approximation that the underlying power spectra are smooth over the support of the kernel functions 
